...
| `set_audio_volume`       | Set volume level for a queue (0.0-1.0)                |
...
| `/queues/{name}/volume` | PUT    | Set volume (0.0-1.0)                                 |
